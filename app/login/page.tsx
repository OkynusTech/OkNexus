            ...
            <div className="w-full max-w-md px-4">
                ...
                <Card className="p-8 shadow-lg border-muted">
                    <div className="space-y-6">
                        ...
                        <div className="mt-4 rounded-md bg-blue-500/10 p-4 border border-blue-500/20">
                            <div className="flex">
                                <div className="ml-3">
                                    <h3 className="text-sm font-medium text-blue-400">Under Active Development</h3>
                                    <div className="mt-2 text-sm text-blue-200/80">
                                        <p>
                                            This application is currently in <strong>BETA</strong>. You may encounter bugs, unfinished features, and data resets.
                                        </p>
                                    </div>
                                </div>
                            </div>
